window.addEventListener("load", function () {
  var requestURL =
    "/project.static.portfolio-1/portfolio_detail_6/data/gnb.json";
  ...
  window.addEventListener("scroll", function () {
    ...
    frameTimer = setTimeout(function () {
      ...
      if (frameWindowTop >= offsetYData[0] && frameWindowTop < offsetYData[1]) {
        ...
        frameWindowTop >= offsetYData[5] &&
        frameWindowTop < offsetYData[6]
      ) {
        count = 5;
      } else if (
        frameWindowTop >= offsetYData[6] &&
        frameWindowTop < offsetYData[7]
      ) {
        count = 6;
      } else if (
        frameWindowTop >= offsetYData[7] &&
        frameWindowTop < offsetYData[8]
      ) {
        count = 7;
      } else if (
        frameWindowTop >= offsetYData[8] &&
        frameWindowTop < offsetYData[9]
      ) {
        count = 8;
      } else if (
        frameWindowTop >= offsetYData[9] &&
        frameWindowTop < offsetYData[10]
      ) {
        count = 9;
